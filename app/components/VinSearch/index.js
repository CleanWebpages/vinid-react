						...
						<div className="col-md-8 offset-md-2 pad-top-2">
							<div className="input-group space-top-2">
								<div className="input-group-prepend">
									<span className="btn btn-xs btn-light">VIN</span>
								</div>
								<input type="text" onKeyDown={this.onKeyDown} className="form-control search-input input-xs" placeholder="Please Input Vin" onFocus={this.onFocus} onChange={this.onChange} name="search" value={this.state.search} />
								<div className="input-group-append btn-xs">
...
export default withRouter(connect(mapStateToProps)(VinSearch));
